...
class RNNCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_h = tf.get_variable(name = 'W_h',shape = (self._state_size,self.state_size),initializer = tf.contrib.layers.xavier_initializer())
            b   = tf.get_variable(name = 'b',shape = {self._state_size,},initializer = tf.contrib.layers.xavier_initializer())
