...
class GRUCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_r = tf.get_variable(name = 'W_r',shape = (self.state_size,self.state_size),initializer = xavier)
            U_r = tf.get_variable(name = 'U_r',shape = (self.input_size,self.state_size),initializer = xavier)
            b_r = tf.get_variable(name = 'b_r',shape = (self.state_size,),initializer = xavier)
            W_z = tf.get_variable(name = 'W_z',shape = (self.state_size,self.state_size),initializer = xavier)
            U_z = tf.get_variable(name = 'U_z',shape = (self.input_size,self.state_size),initializer = xavier)
            b_z = tf.get_variable(name = 'b_z',shape = (self.state_size,),initializer = xavier)
            W_o = tf.get_variable(name = 'W_o',shape = (self.state_size,self.state_size),initializer = xavier)
            U_o = tf.get_variable(name = 'U_o',shape = (self.input_size,self.state_size),initializer = xavier)
            b_o = tf.get_variable(name = 'b_o',shape = (self.state_size,),initializer = xavier)
